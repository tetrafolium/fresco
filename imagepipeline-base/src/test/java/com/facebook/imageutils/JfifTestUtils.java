...
public class JfifTestUtils {
  ...
  public static int numBytes(final String data) {
  ...
  public static String encodeInt2HexString(final int value, final int length, final boolean littleEndian) {
  ...
  public static String makeSOFSection(final int length, final int bitDepth, final int width, final int height) {
    return SOF_MARKER
  ...
  public static String makeOrientationEntry(final int orientation, final boolean isLittleEnd) {
    return makeIfdEntry(IFD_ENTRY_ORI_TAG, TYPE_SHORT, 1, orientation, 2, isLittleEnd);
  }

  public static String makeIfdEntry(
      final int tag, final int type, final int count, final int value, final int valueNumBytes, final boolean littleEndian) {
  ...
  public static String makeIfd(final String[] IfdEntries, final int nextEntryOffset, final boolean littleEndian) {
  ...
  public static String makeTiff(final String ifd, final boolean littleEndian) {
    String ret = littleEndian ? TIFF_HEADER_LE : TIFF_HEADER_BE;
    return ret + ifd;
  }

  public static String makeAPP1_EXIF(final String tiff) {
    String app1Length = encodeInt2HexString(numBytes(tiff) + 8, 2, false);
    return APP1_MARKER + app1Length + APP1_EXIF_MAGIC + tiff;
  }

  public static String makeTestImageWithAPP1(final String APP1) {
