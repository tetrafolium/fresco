...
public class ImagePerfData {
  ...
  public ImagePerfData(
      final @Nullable String controllerId,
      final @Nullable String requestId,
      final @Nullable ImageRequest imageRequest,
      final @Nullable Object callerContext,
      final @Nullable ImageInfo imageInfo,
      final @Nullable ImageRequest controllerImageRequest,
      final @Nullable ImageRequest controllerLowResImageRequest,
      final @Nullable ImageRequest[] controllerFirstAvailableImageRequests,
      final long controllerSubmitTimeMs,
      final long controllerIntermediateImageSetTimeMs,
      final long controllerFinalImageSetTimeMs,
      final long controllerFailureTimeMs,
      final long controllerCancelTimeMs,
      final long imageRequestStartTimeMs,
      final long imageRequestEndTimeMs,
      final @ImageOrigin int imageOrigin,
      final @Nullable String ultimateProducerName,
      final boolean isPrefetch,
      final int onScreenWidthPx,
      final int onScreenHeightPx,
      final @Nullable Throwable errorThrowable,
      final int visibilityState,
      final long visibilityEventTimeMs,
      final long invisibilityEventTime,
      final @Nullable String componentTag,
      final long imageDrawTimeMs,
      final @Nullable DimensionsInfo dimensionsInfo,
      final @Nullable Extras extraData) {
